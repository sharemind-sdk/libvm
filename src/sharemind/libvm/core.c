...
#define SHAREMIND_MI_TNE_FLOAT32(d,s1,s2) SHAREMIND_SF_FPUF((d),!,sf_float32_eq((s1),(s2),p->fpuState))
#define SHAREMIND_MI_TNE_FLOAT64(d,s1,s2) SHAREMIND_SF_FPUF((d),!,sf_float64_eq((s1),(s2),p->fpuState))
...
#define SHAREMIND_MI_CONVERT_float32_TO_int8(a,b)   SHAREMIND_SF_E_CAST((a),int8_t,sf_int32,sf_result32i,,sf_float32_to_int32((b),p->fpuState))
#define SHAREMIND_MI_CONVERT_float32_TO_int16(a,b)  SHAREMIND_SF_E_CAST((a),int16_t,sf_int32,sf_result32i,,sf_float32_to_int32((b),p->fpuState))
#define SHAREMIND_MI_CONVERT_float32_TO_int32(a,b)  SHAREMIND_SF_E_CAST((a),int32_t,sf_int32,sf_result32i,,sf_float32_to_int32((b),p->fpuState))
#define SHAREMIND_MI_CONVERT_float32_TO_int64(a,b)  SHAREMIND_SF_E_CAST((a),int64_t,sf_int64,sf_result64i,,sf_float32_to_int64((b),p->fpuState))
#define SHAREMIND_MI_CONVERT_float32_TO_uint8(a,b)  SHAREMIND_SF_E_CAST((a),uint8_t,sf_int32,sf_result32i,,sf_float32_to_int32((b),p->fpuState))
#define SHAREMIND_MI_CONVERT_float32_TO_uint16(a,b) SHAREMIND_SF_E_CAST((a),uint16_t,sf_int32,sf_result32i,,sf_float32_to_int32((b),p->fpuState))
#define SHAREMIND_MI_CONVERT_float32_TO_uint32(a,b) SHAREMIND_SF_E_CAST((a),uint32_t,sf_int64,sf_result64i,,sf_float32_to_int64((b),p->fpuState))
...
#define SHAREMIND_MI_CONVERT_float64_TO_int8(a,b)   SHAREMIND_SF_E_CAST((a),int8_t,sf_int32,sf_result32i,,sf_float64_to_int32((b),p->fpuState))
#define SHAREMIND_MI_CONVERT_float64_TO_int16(a,b)  SHAREMIND_SF_E_CAST((a),int16_t,sf_int32,sf_result32i,,sf_float64_to_int32((b),p->fpuState))
#define SHAREMIND_MI_CONVERT_float64_TO_int32(a,b)  SHAREMIND_SF_E_CAST((a),int32_t,sf_int32,sf_result32i,,sf_float64_to_int32((b),p->fpuState))
#define SHAREMIND_MI_CONVERT_float64_TO_int64(a,b)  SHAREMIND_SF_E_CAST((a),int64_t,sf_int64,sf_result64i,,sf_float64_to_int64((b),p->fpuState))
#define SHAREMIND_MI_CONVERT_float64_TO_uint8(a,b)  SHAREMIND_SF_E_CAST((a),uint8_t,sf_int32,sf_result32i,,sf_float64_to_int32((b),p->fpuState))
#define SHAREMIND_MI_CONVERT_float64_TO_uint16(a,b) SHAREMIND_SF_E_CAST((a),uint16_t,sf_int32,sf_result32i,,sf_float64_to_int32((b),p->fpuState))
#define SHAREMIND_MI_CONVERT_float64_TO_uint32(a,b) SHAREMIND_SF_E_CAST((a),uint32_t,sf_int64,sf_result64i,,sf_float64_to_int64((b),p->fpuState))
