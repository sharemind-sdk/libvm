...
#define SMVM_ENUM_Exception \
    ...
    ((SMVM_E_UNKNOWN_FPE, = 0x401)) \
    ((SMVM_E_INTEGER_DIVIDE_BY_ZERO, = 0x402)) \
    ((SMVM_E_INTEGER_OVERFLOW, = 0x403)) \
    ((SMVM_E_FLOATING_POINT_DIVIDE_BY_ZERO, = 0x404)) \
    ((SMVM_E_FLOATING_POINT_OVERFLOW, = 0x405)) \
    ((SMVM_E_FLOATING_POINT_UNDERFLOW, = 0x406)) \
    ((SMVM_E_FLOATING_POINT_INEXACT_RESULT, = 0x407)) \
    ((SMVM_E_FLOATING_POINT_INVALID_OPERATION, = 0x408)) \
